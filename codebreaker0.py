...
def codebreaker(evaluation_p):
    ...
    elle joue au hasard.
    """
    return ''.join(random.choices(common.COLORS, k=common.LENGTH)) # prends au hasard une combiansion dans toutes celles qui existent 
# cela pourra impliquer de retester plusieurs fois la même combianaison
